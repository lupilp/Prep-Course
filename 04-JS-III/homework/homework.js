...
function dePalabrasAFrase(palabras) {
  ...
  // var stringConcatenada = palabras.pop()
...
function promedioResultadosTest(resultadosTest) {
  ...
  for (var i = 0; i < resultadosTest.length; i++) {
    resultado1 = resultado1 + resultadosTest[i];
  }
  promedio = resultado1 / resultadosTest.length;
  return promedio;
}
